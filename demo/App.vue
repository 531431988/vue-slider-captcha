<template>
  <div id="app">
    <a-row type="flex" align="middle" justify="center">
      <a-col>
        <VueSliderCaptcha ref="sliderCaptcha" v-model="status" width="400" height="250" :src="src" :sliderSrc="sliderSrc" :y="y" @on-refresh="onRefresh" @on-finish="onFinish"></VueSliderCaptcha>
